import { genshinStickers } from '/GenshinData.js'
...
function generateModal(genshinStickers) {
...
function changeBackground(e) {
    ...
    if (emblemId === "mondstadEmblem") {
        ...
        if (inazumaBackground) {
            inazumaBackground.style.display = "block"
        }
    }
    else if (emblemId === "sumeruEmblem") {
        let inazumaBackground = document.getElementById("sumeruBackground")
        if (sumeruBackground) {
            sumeruBackground.style.display = "block"
        }
    }
    else if (emblemId === "fontaineEmblem") {
        let inazumaBackground = document.getElementById("fontaineBackground")
        if (fontaineBackground) {
